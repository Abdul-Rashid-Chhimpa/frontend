                        ...
                        <div className="flex items-center gap-2 overflow-x-auto">
                            ...
                            {["all", "active", "blocked"].map((f) => (
                                <button
                                    ...
                                    className={`px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-semibold capitalize whitespace-nowrap transition ${statusFilter === f
                                ...
                                {filteredUsers.length === 0 ? (
                                            ...
                                            <td className="px-4 lg:px-6 py-4">
                                                <div className="flex items-center justify-center gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`p-2 rounded-lg transition disabled:opacity-50 ${user.status === "active"
                                    ...
                                    filteredUsers.map((user) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 lg:px-6 py-4">
                                                <span
                                                    className={`inline-flex px-2.5 py-1 rounded-full text-xs font-semibold ${user.status === "active"
                                    ...
                                    <div className="relative shrink-0">
                                        ...
                                        {menuOpenId === user._id && (
                                            <div className="absolute right-0 top-9 z-20 w-36 bg-white rounded-xl border border-gray-100 shadow-xl py-1.5">
                                                ...
                                                <button
                                                    onClick={() => toggleBlock(user._id)}
                                                    className={`w-full flex items-center gap-2 px-3 py-2.5 text-sm ${user.status === "active"
                    ...
                    <div className="relative w-full sm:max-w-md bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-5 space-y-4">
                            ...
                            <button
                                ...
                                className={`w-full py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 disabled:opacity-50 transition ${selectedUser.status === "active"
